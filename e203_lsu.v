...
module e203_lsu(
  ...
  input  [4-1:0]     nice_icb_cmd_wmask,
  ...
  wire  [32-1:0]   dcache_icb_cmd_addr; 
  wire                          dcache_icb_cmd_read; 
  wire  [32-1:0]        dcache_icb_cmd_wdata;
  wire  [32/8-1:0]      dcache_icb_cmd_wmask;
  ...
  wire  [32-1:0]        dcache_icb_rsp_rdata;
  `endif//}
