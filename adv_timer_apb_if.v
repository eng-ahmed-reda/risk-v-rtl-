...
module adv_timer_apb_if #(
    ...
    always @(posedge HCLK or negedge HRESETn) begin
        if (~HRESETn) begin
            ...
            case (s_apb_addr)
                8'b00000010:  // REG_TIM0_TH
                    r_timer0_th <= PWDATA;
                8'b00000000:  // REG_TIM0_CMD
                begin
