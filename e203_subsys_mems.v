...
module e203_subsys_mems(
  ...
  input  [32-1:0]   mem_icb_cmd_addr, 
  input                          mem_icb_cmd_read, 
  input  [32-1:0]        mem_icb_cmd_wdata,
  input  [32/8-1:0]      mem_icb_cmd_wmask,
  //
  output                         mem_icb_rsp_valid,
  input                          mem_icb_rsp_ready,
  output                         mem_icb_rsp_err,
  output [32-1:0]        mem_icb_rsp_rdata,
