...
(
	...
	end else if ((((interrupt && PSEL) && PENABLE) && !PWRITE) && (s_apb_addr == 4'b0110)) begin    //clears int if status is read
            interrupt <= 1'b0;
            r_status  <= 'h0;
        end
    end
    ...
    always @(*) begin
        case (s_apb_addr)
            4'b0000:    PRDATA = r_gpio_dir;      // REG_PADDIR
            4'b0001:    PRDATA = r_gpio_in;       // REG_PADIN
            4'b0010:    PRDATA = r_gpio_out;      // REG_PADOUT
            4'b0011:    PRDATA = r_gpio_inten;    // REG_INTEN
            4'b0100:    PRDATA = r_gpio_inttype0; // REG_INTTYPE0
            4'b0101:    PRDATA = r_gpio_inttype1; // REG_INTTYPE1
            4'b0110:    PRDATA = r_status;        // REG_INTSTATUS
            4'b0111:    PRDATA = r_iofcfg;        // REG_IOFCFG
            4'b1000:    PRDATA = {2'b00, gpio_padcfg[18+:6], 2'b00, gpio_padcfg[12+:6], 2'b00, gpio_padcfg[6+:6], 2'b00, gpio_padcfg[0+:6]};   // REG_PADCFG0
            4'b1001:    PRDATA = {2'b00, gpio_padcfg[42+:6], 2'b00, gpio_padcfg[36+:6], 2'b00, gpio_padcfg[30+:6], 2'b00, gpio_padcfg[24+:6]};   // REG_PADCFG1
            4'b1010:    PRDATA = {2'b00, gpio_padcfg[66+:6], 2'b00, gpio_padcfg[60+:6], 2'b00, gpio_padcfg[54+:6], 2'b00, gpio_padcfg[48+:6]};   // REG_PADCFG2
            4'b1011:    PRDATA = {2'b00, gpio_padcfg[90+:6], 2'b00, gpio_padcfg[84+:6], 2'b00, gpio_padcfg[78+:6], 2'b00, gpio_padcfg[72+:6]};   // REG_PADCFG3
            4'b1100:    PRDATA = {2'b00, gpio_padcfg[114+:6], 2'b00, gpio_padcfg[108+:6], 2'b00, gpio_padcfg[102+:6], 2'b00, gpio_padcfg[96+:6]};  // REG_PADCFG4
            4'b1101:    PRDATA = {2'b00, gpio_padcfg[138+:6], 2'b00, gpio_padcfg[132+:6], 2'b00, gpio_padcfg[126+:6], 2'b00, gpio_padcfg[120+:6]};  // REG_PADCFG5
            4'b1110:    PRDATA = {2'b00, gpio_padcfg[162+:6], 2'b00, gpio_padcfg[156+:6], 2'b00, gpio_padcfg[150+:6], 2'b00, gpio_padcfg[144+:6]};  // REG_PADCFG6
            4'b1111:    PRDATA = {2'b00, gpio_padcfg[186+:6], 2'b00, gpio_padcfg[180+:6], 2'b00, gpio_padcfg[174+:6], 2'b00, gpio_padcfg[168+:6]};  // REG_PADCFG7
            default: PRDATA = 'h0;
        endcase
    end
