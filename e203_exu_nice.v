...
module e203_exu_nice(
  ...
  input [32-1:0]   nice_i_instr,
  input [32-1:0]   nice_i_rs1,
  input [32-1:0]   nice_i_rs2,
  //input                    nice_i_mmode , // O: current insns' mmode 
  input  [5-1:0] nice_i_itag,
...
wire          fifo_i_rdy;
wire [5-1:0] fifo_i_dat = nice_i_itag;

wire          fifo_o_rdy = itag_fifo_ren;
wire [5-1:0] fifo_o_dat; 
assign nice_o_itag_valid = fifo_o_vld & nice_rsp_multicyc_valid;
//assign nice_o_itag = {5{nice_o_itag_valid}} & fifo_o_dat;
