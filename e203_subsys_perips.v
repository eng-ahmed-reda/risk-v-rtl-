...
module e203_subsys_perips(
  ...
  input  [32-1:0]        ppi_icb_cmd_wdata,
  input  [32/8-1:0]      ppi_icb_cmd_wmask,
  //
  output                         ppi_icb_rsp_valid,
  input                          ppi_icb_rsp_ready,
  output                         ppi_icb_rsp_err,
  output [32-1:0]        ppi_icb_rsp_rdata,
...
sirv_flash_qspi_top u_sirv_qspi0_top(
  ...
  wire [31:0] gpioA_apb_paddr;
  wire gpioA_apb_pwrite;
  wire gpioA_apb_pselx;
  wire gpioA_apb_penable;
  wire [32-1:0] gpioA_apb_pwdata;
  wire [32-1:0] gpioA_apb_prdata;
...
apb_gpio # (
  ...
  wire [31:0] gpioB_apb_paddr;
  wire gpioB_apb_pwrite;
  wire gpioB_apb_pselx;
  wire gpioB_apb_penable;
  wire [32-1:0] gpioB_apb_pwdata;
  wire [32-1:0] gpioB_apb_prdata;
...
apb_gpio # (
  ...
  wire [32-1:0] uart0_apb_pwdata;
  wire [32-1:0] uart0_apb_prdata;
...
apb_uart_sv # (
  ...
  wire [32-1:0] uart1_apb_pwdata;
  wire [32-1:0] uart1_apb_prdata;
...
apb_uart_sv # (
  ...
  wire [31:0] uart2_apb_paddr;
  wire uart2_apb_pwrite;
  wire uart2_apb_pselx;
  wire uart2_apb_penable;
  wire [32-1:0] uart2_apb_pwdata;
  wire [32-1:0] uart2_apb_prdata;
...
apb_uart_sv # (
  ...
  wire [31:0] spi1_apb_paddr;
  wire spi1_apb_pwrite;
  wire spi1_apb_pselx;
  wire spi1_apb_penable;
  wire [32-1:0] spi1_apb_pwdata;
  wire [32-1:0] spi1_apb_prdata;
...
apb_spi_master #(
  ...
  wire [31:0] spi2_apb_paddr;
  wire spi2_apb_pwrite;
  wire spi2_apb_pselx;
  wire spi2_apb_penable;
  wire [32-1:0] spi2_apb_pwdata;
  wire [32-1:0] spi2_apb_prdata;
...
apb_spi_master #(
  ...
  // * APB Peripheral:  I2C0
  wire [31:0] i2c0_apb_paddr;
  wire i2c0_apb_pwrite;
  wire i2c0_apb_pselx;
  wire i2c0_apb_penable;
  wire [32-1:0] i2c0_apb_pwdata;
  wire [32-1:0] i2c0_apb_prdata;
...
apb_i2c #(
  ...
  // * APB Peripheral:  I2C1
  wire [31:0] i2c1_apb_paddr;
  wire i2c1_apb_pwrite;
  wire i2c1_apb_pselx;
  wire i2c1_apb_penable;
  wire [32-1:0] i2c1_apb_pwdata;
  wire [32-1:0] i2c1_apb_prdata;
...
apb_i2c #(
  ...
  // * APB Peripheral:  PWM 
  wire [31:0] pwm_apb_paddr;
  wire pwm_apb_pwrite;
  wire pwm_apb_pselx;
  wire pwm_apb_penable;
  wire [32-1:0] pwm_apb_pwdata;
  wire [32-1:0] pwm_apb_prdata;
...
apb_adv_timer #(
  ...
  wire [32-1:0] expl_axi_rdata;
  wire [1:0] expl_axi_rresp;
  wire expl_axi_rlast;

  wire expl_axi_wvalid;
  wire expl_axi_wready;
  wire [32-1:0] expl_axi_wdata;
  wire [(32/8)-1:0] expl_axi_wstrb;
  wire expl_axi_wlast;
